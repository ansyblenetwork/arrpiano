...
One can imagine constructing the notes of a piano by cycling through the fifths as described until 12 notes have been generated, and then completing the rest of the piano by simply extending by octaves. For instance, starting with C, we would end with F.
