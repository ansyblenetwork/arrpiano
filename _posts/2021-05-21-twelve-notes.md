...
In the spirit of my [recent commentary]({% post_url 2021-05-19-music-and-mathematics %}) on taking a systematic approach, we first observe that this question can be decomposed into two questions:
...
The answer to the second question is, I think, more subtle. My short answer would be that it is related to _variety_, _symmetry_ and _continuity_. Variety refers to the obvious fact that music should use more than one note. But by a quirk of arithmetic, having only say, two or some other small number of consonant notes would result in an asymmetric and scattered arsenal of pitches. We will see that by imposing some reasonable requirements, we find ourselves with twelve notes.
